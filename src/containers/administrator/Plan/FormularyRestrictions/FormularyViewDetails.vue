    ...
    <v-layout row>
      ...
      <v-flex xs8>
        <v-text-field
          name="plan-id"
          label="Plan ID"
          v-model="planFormularyRestrictions.plan_id"
    ...
    <v-layout row>
      ...
      <v-flex xs8>
        <v-text-field
          name="provider-id"
          label="Provider ID"
          v-model="planFormularyRestrictions.provider_id"
          :rules="[rules.required]"
        ></v-text-field>
      </v-flex>
    </v-layout>
    ...
    <v-layout row>
      ...
      <v-flex xs8>
        <v-text-field
          name="drug-id"
          label="Drug ID"
          v-model="planFormularyRestrictions.drug_id"
          :rules="[rules.required]"
        ></v-text-field>
      </v-flex>
    </v-layout>
    ...
    <v-layout row>
      ...
      <v-flex xs8>
        <v-text-field
          name="member-id"
          label="Member ID"
          v-model="planFormularyRestrictions.member_id"
          :rules="[rules.required]"
        ></v-text-field>
      </v-flex>
    </v-layout>
    ...
    <v-layout row>
      ...
      <v-flex xs8>
        <v-text-field
          ...
          v-model="planFormularyRestrictions.invoice_number"
        ></v-text-field>
      </v-flex>
    </v-layout>
      ...
      <v-flex xs8>
        <v-menu
          ...
          <v-text-field slot="activator"
                        label="Fill Date"
                        v-model="planFormularyRestrictions.fill_dt"
                        prepend-icon="event"
                        readonly
          ></v-text-field>

          <v-date-picker v-model="planFormularyRestrictions.fill_dt" no-title scrollable actions />
    ...
    <v-layout row>
      ...
      <v-flex xs8>
        <v-menu
          ...
          <v-text-field slot="activator"
                        label="Date Received"
                        v-model="planFormularyRestrictions.date_received"
                        prepend-icon="event"
                        readonly></v-text-field>
          <v-date-picker v-model="planFormularyRestrictions.date_received" no-title scrollable actions />
        </v-menu>
      </v-flex>
    </v-layout>
...
//  import MacService from '../../../../services/pbmsys/MacService'
  ...
  export default {
    ...
    props: ['planFormularyRestrictions'],
    data() {
      return {
        description: '',
        received_menu: '',
